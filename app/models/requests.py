...
class RequestorEmails(db.Model):
    ...
    request_id = db.Column(db.String, db.ForeignKey(
...
class RequestSchema(ma.Schema):
    ...
    jobid = fields.String()
    emails = fields.Nested(RequestorEmailsSchema,
                           many=True, exclude=('request_id'))
    result = ma.URLFor('api.resultsresource', id='<jobid>',
